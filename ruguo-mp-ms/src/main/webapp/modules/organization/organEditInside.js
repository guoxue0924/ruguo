...
require([configPath], function (c) {
    ...
    require(['dialog', 'common', 'select', 'valid','area'/*, 'files', 'spinner'*/], function (BootstrapDialog, common,select,data,valid) {
        $(function () {
            ...
            //初始化CodeList数据
        	common.CodeListDataSet.init(['DICT_ORG_TYPE_1','DICT_PLATFORM_TYPE']);
...
//                $('#userForm input:checkbox').attr('checked', false);//重置checkbox
            ...
            valid = $.bootValid('#organForm', {
                rules: {
                    ...
                    contactPerson: ['not_empty',{'max_length':50}],
                    contactPhone: ['not_empty','phone_num'],
                    orgPostCode: ['post'],
                    orgFax: ['tel'],
                    orgUrl: ['url']
                },
...
//                            if (result) {
                                ...
                                var uri = "organization/organ/saveInside";
