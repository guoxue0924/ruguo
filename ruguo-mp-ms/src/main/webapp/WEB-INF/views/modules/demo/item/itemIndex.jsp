                            ...
                            <div class="form-group form-group-sm">
                                ...
                                <div class="search-input-left">
                                    <div class="input-group input-group-sm">
                                        <input type="text" class="form-control" id="s_xzqh" name="" placeholder="点击按钮选择行政区划" autocomplete="off">
                ...
                <div class=" panel-body">
	                <table id="itemgrid" class="table table-hover">
                         <thead class="bg-default" id="thead">
                          <tr>
                              <th data-width="58px" data-header-Align="left" data-align="left" data-column-id="itemId" data-identifier="true" data-visible="true">序号</th>
                              <th data-width="140px" data-align="center" data-column-id="itemCode" data-sortable="false" data-formatter="itemCode" data-visibletitle="true">项目编号</th>
                              <th data-column-id="itemName" data-visibletitle="true">项目名称</th>
                              <th data-width="100px" data-align="right" data-column-id="amount" data-formatter="amount" data-cssclass="text-red amount">项目金额</th>
                              <th data-width="90px" data-align="center" data-column-id="createTime" data-visibletitle="true">创建日期</th>
                              <th data-width="110px" data-align="center" data-column-id="purchase" data-formatter="purchase" data-sortable="false">采购方式</th>
                              <th data-width="90px" data-align="center" data-column-id="itemState" data-formatter="itemState" data-sortable="false">启用状态</th>
                ...
                <div class=" panel-body">
                    <table d="" class="table table-hover ">
                        ...
                        <tr class="tr">
                            ...
                            <th width="58px" data-header-Align="left" data-align="left" data-column-id="itemId" data-identifier="true" data-visible="true">序号</th>
...
<!--                              <th width="50px" data-column-id="associate">委托机构</th>-->
            ...
            <script src="<%=request.getContextPath()%>/plugins/require/require.js" defer async="true" data-main="<%=request.getContextPath()%>/modules/demo/item/itemIndex"></script>
