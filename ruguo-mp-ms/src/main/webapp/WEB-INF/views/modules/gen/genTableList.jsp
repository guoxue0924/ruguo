...
<div class="panel panel-default panel-search">
            ...
            <div class="col-xs-12-sm">
                <div class="col-xs-4">
                    <div class="form-group form-group-sm">
                        <label class="col-xs-5-sm control-label">表名：</label>

                        <div class="col-xs-7-sm">
                            <input type="text" maxlength="64" value="" name="name" id="name"
                                   class="form-control" placeholder="请输入表名">
                        </div>
                    </div>
                </div>
                <div class="col-xs-4">
    ...
    <div class="panel-heading-gray text-right">
        <button class="btn btn-primary btn-xs" id="btnAdd">添加业务表</button>
    </div>
    <div class=" panel-body">
        <table id="genTableGrid" class="table table-hover">
            ...
            <tr>
                ...
                <th data-width="" data-align="left" data-headerAlign="left" data-column-id="datasource">数据源
                </th>
                <th data-width="" data-align="left" data-headerAlign="left" data-column-id="name" data-sortable="true" data-sortable-column="a.name">表名
                </th>
                <th data-width="" data-align="left" data-headerAlign="left" data-column-id="comments">描述</th>
                <th data-width="" data-align="left" data-headerAlign="left" data-column-id="className">实体类名称</th>
...
<script src="<%=request.getContextPath()%>/plugins/require/require.js" defer async="true"
        data-main="<%=request.getContextPath()%>/modules/gen/genTableList"></script>
