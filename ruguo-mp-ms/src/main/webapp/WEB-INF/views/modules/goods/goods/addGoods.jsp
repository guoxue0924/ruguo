...
<div class="panel panel-default">
    ...
    <form id="goodsForm" name="goodsForm" enctype="multipart/form-data">
        <div class="panel-body form-horizontal">
            ...
            <input type="hidden" class="goodsCode" name="goodsCode" value="${goodsCode }">
						...
						<div class="col-xs-3-sm">
							...
							<input type="hidden" id="goodsClass" name="goodsClassCode">
						        ...
						        <span class="input-group-btn">
						            <button class="btn btn-default" type="button" id="jgbtn">
						...
						<div class="col-xs-3-sm">
							<select class="selectpicker " name="serviceOrgLevelCode" id="serviceOrgLevelCode"
                                ...
                                <c:forEach items="${fns:getDictList('DICT_HEALTH_ORG_LEVEL')}"
                                    ...
                                    <option value="${DICT_HEALTH_ORG_LEVEL.value}">${DICT_HEALTH_ORG_LEVEL.label}</option>
                                </c:forEach>
                            </select>
						</div>
						...
						<div class="col-xs-3-sm">
							<select class="selectpicker " name="serviceOrgRankCode" id="serviceOrgRankCode"
                                ...
                                <c:forEach items="${fns:getDictList('DICT_HOS_GRADE')}"
                                           var="DICT_HOS_GRADE">
                                    <option value="${DICT_HOS_GRADE.value}">${DICT_HOS_GRADE.label}</option>
                                </c:forEach>
                            </select>
						</div>
						...
						<div class="col-xs-3-sm">
							<select class="selectpicker " name="servicePersonTypeCode" id="servicePersonTypeCode"
                                ...
                                <c:forEach items="${fns:getDictList('DICT_SERVICE_PERSON_TYPE')}"
                                    ...
                                    <option value="${DICT_SERVICE_PERSON_TYPE.value}">${DICT_SERVICE_PERSON_TYPE.label}</option>
                                </c:forEach>
                            </select>
						</div>
                ...
                <div class="col-xs-5-sm">
                    <c:forEach items="${fns:getDictListNoBlank('DICT_SERVICE_PERSON_LEVEL')}" var="DICT_SERVICE_PERSON_LEVEL">
							<label class="radio-inline">
		                        <input type="radio" id="servicePersonLevelCode" name="servicePersonLevelCode" value="${DICT_SERVICE_PERSON_LEVEL.value}" > ${DICT_SERVICE_PERSON_LEVEL.label}
		                    </label>
					</c:forEach>
                </div>
						...
						<div class="col-xs-3-sm">
							<select class="selectpicker " name="servicePersonMajorCode" id="servicePersonMajorCode"
                                ...
                                <c:forEach items="${fns:getDictList('DICT_DOC_PRACTICE_SCOPE')}"
                                    ...
                                    <option value="${DICT_DOC_PRACTICE_SCOPE.value}">${DICT_DOC_PRACTICE_SCOPE.label}</option>
                                </c:forEach>
                            </select>
						</div>
			...
			<div class="form-group" data-msg-direction="r" id="aa">
             ...
             <div class="form-group" data-msg-direction="r">
                ...
                <div class="col-xs-1-sm" data-toggle="popover" data-trigger="focus"
                     data-content="请输入数字">
                    <input type="text" class="form-control" name="probationPeriod">
                </div>
                 <div class="col-xs-1-sm" style="margin-left: 10px;margin-top: 10px;">
                 <div >天</div>
                 </div>
                ...
                <div class="col-xs-3-sm">
							<select class="selectpicker " name="servicePackageCodeArr" id="servicePackageCodeArr"
                                ...
                                <c:forEach items="${ServicePackageName}"
                                           var="SERVICE_PACKAGE">
                                    <option value="${SERVICE_PACKAGE.servicePackageCode}">${SERVICE_PACKAGE.servicePackageName}</option>
                                </c:forEach>
                            </select>
				</div>
            </div>
            ...
            <img src="../../images/timg.jpg" id="headImg" class="headImg" style="width:100%;height:100%;line-height:60px;text-align:center" ><!--  style="background-image: url(http://localhost/common/file/show?fileId=${result.data.picId});" --> 
                	...
                	<!-- <div class="input-group">
                         <input type="text" class="form-control file-input-label" placeholder="请选择文件" readOnly
                                aria-describedby="sizing-addon3" autocomplete="off" style="display: none;">
                         <span class="input-group-btn" tabindex="0">
                         	<label for="file1" class="btn btn-default form-control file-input-label-for" style="display: none;">
           ...
           <!--  <div class="form-group" data-msg-direction="r">
            ...
            <div class="form-group" data-msg-direction="r">
                ...
                <div class="col-xs-2-sm">
                    <c:forEach items="${fns:getDictListNoBlank('DICT_IDENTITY_FLAG')}" var="DICT_IDENTITY_FLAG">
							<label class="radio-inline">
		                        <input type="radio" name="isRecommend" value="${DICT_IDENTITY_FLAG.value}" > ${DICT_IDENTITY_FLAG.label}
		                    </label>
					</c:forEach>
                </div>
              ...
              <div class="form-group" data-msg-direction="r">
                ...
                <!-- <div class="col-xs-3-sm" data-toggle="popover" data-trigger="focus"
                 ...
                 <div class="col-xs-3-sm">
                <div class="b_headImg" style="width:60px;height:60px;line-height:60px;text-align:center;">
            <img src="../../images/timg.jpg" id="recommendImg" class="recommendImg" style="width:100%;height:100%;line-height:60px;text-align:center" ><!--  style="background-image: url(http://localhost/common/file/show?fileId=${result.data.picId});" --> 
            ...
            <div class="form-group" data-msg-direction="r" id="aa">
                ...
                <div class="col-xs-2-sm" data-toggle="popover" data-trigger="focus" >
                     <button type="button" class="btn btn-primary btn-xs" id="addTagsButton">添加+</button> 
                </div>
            ...
            <div class="form-group" data-msg-direction="r">
                ...
                <div class="col-xs-1-sm" data-toggle="popover" data-trigger="focus"
                     data-content="请输入50位有效字符">
                    <input type="text" class="form-control" id="tagMatchedNum" name="tagMatchedNum" >
                    <input type="hidden"  id="tagMatchedNumCount" name="tagMatchedNumCount" >
                </div>
            </div>
...
<script src="<%=request.getContextPath()%>/modules/goods/goods/addGoods.js"></script>
