		    ...
		    123456789
                ...
                <div class="form-group">
			     ...
			     <div class="form-group">
                   ...
                   <div class="col-xs-2-sm">
                    <input type="hidden" class="form-control" name=operationExaminer value="${user.id}" >
                        <span class="control-label-text">
                            ${user.name}
                        </span>
                    </div>
		            ...
		            <div class="col-xs-2-sm">
	                    <c:forEach items="${fns:getDictListNoBlank('DICT_AGREE_OR_NOT')}" var="DICT_AGREE_OR_NOT">
							<label class="radio-inline">
		                        <input type="radio" name="approvalStatus" value="${DICT_AGREE_OR_NOT.value}" > ${DICT_AGREE_OR_NOT.label}
		                    </label>
						</c:forEach>
	                </div>
		        </div>
...
<script src="<%=request.getContextPath()%>/modules/order/orderquery/orderBasicInfoAudit.js"></script>	
