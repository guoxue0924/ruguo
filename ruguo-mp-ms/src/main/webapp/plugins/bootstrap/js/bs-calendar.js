	...
	$.fn.calendar = function(options) {
	    ...
	    this.each(function(){
	        ...
	        function showDaysOfMonth(month, year){
	            ...
	            for (var i=0; i<7; i++){
	                if (i < firstDay){
	                    ...
	                    if (i == 0)
	                        dayCode += "<tr>";
	                    // if the day of the week is less than the number of the
						// first day of the week do not put anything in the cell
	        ...
	        function checkdate (m, d, y) {
	            ...
	            // extracted from the manual phpjs.org libraries at
				// http://www.desarrolloweb.com/manuales/manual-librerias-phpjs.html
