 ...
 */
package com.foundation.common.web;
...
public abstract class BaseController {
	...
	public void uploadException(HttpServletResponse response, UploadException e) throws IOException {  
		response.setStatus(430);
		response.setHeader("Content-type", "text/html;charset=UTF-8"); 
		response.setCharacterEncoding("UTF-8"); 
		responseHelper.setFail(e.getMessage());
